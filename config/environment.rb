...
Rails::Initializer.run do |config|
	config.action_controller.session = { :key => "_myapp_session", :secret => "9093cb363066b87a7bc598a769695a5ffc3c4be5" }
  ...
  #	config.gem 'hpricot', :version => '0.6.164', :source => "http://code.whytheluckystiff.net"
  #	config.gem 'mislav-will_paginate', :lib => 'will_paginate', :version => '2.3.7', :source => 'http://gems.github.com'
  #	config.gem 'haml'
  #	config.gem 'haml_scaffold', :source => 'http://gems.github.com'
